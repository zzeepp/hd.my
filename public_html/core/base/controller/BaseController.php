...
abstract class BaseController
{
    ...
    protected $inputMethod;  //метод для сбора данных из бд
    protected $outputMethod; // метод для подключения вида
    ...
    {
        if(is_array($this->page)) foreach($this->page as $block) echo $block;
        else echo $this->page;
