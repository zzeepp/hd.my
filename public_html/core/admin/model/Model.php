...
class Model extends BaseModel
{
    ...
    public function showForeignKeys($table,
                                    $key = false)
    {
        $db    = DB_NAME;
        $where = '';
    ...
    public function updateMenuPosition($table,
                                       $row,
                                       $where,
                                       $end_pos,
                                       $update_rows = [])
    ...
    public function search($data,
                           ...
                           $qty = false)
    {
        $dbTables = $this->showTables(); //получаем все таблицы
        ...
        $projectTables = Settings::get('projectTables'); //получаем список таблик для поиска
    ...
    protected function createWhereOrder($searchRows,
                                        $searchArr,
                                        $orderRows,
                                        $table)
    {
