<div class="vg-wrap vg-element vg-ninteen-of-twenty">
    ...
    <?php if($this->data): ?>
        <?php foreach($this->data as $data): ?>
            <div class="vg-element vg-fourth">
                <a
                        href="<?= $data['alias']?:$this->adminPath . 'edit/' .  $this->table . '/' .  $data['id'] ?>"
                        class="vg-wrap vg-element vg-full vg-firm-background-color4 vg-box-shadow show_element vg-element-border"
                >
                    <div class="vg-element vg-half vg-center">

                        <?php if($data['img']): ?>
                            <img
                                    src="<?= PATH . UPLOAD_DIR . $data['img'] ?>"
                                    alt="service"
                            >
                        <?php endif; ?>
                    </div>
